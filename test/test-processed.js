...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__dist_loader_js__ = __webpack_require__(1);
...
var PreJS = function () {
  ...
  _createClass(PreJS, [{
    ...
    key: '_genericLoader',
    value: function _genericLoader(item) {
      var _this = this;
    ...
    value: function _updateProgress() {
      ...
      this.itemsToLoad.map(function (item) {
